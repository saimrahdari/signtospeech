...
class QuestionnairesPage extends StatefulWidget {
  QuestionnairesPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      bottomNavigationBar: Container(
        ...
        stream: FirebaseFirestore.instance.collection('users').doc(currentUser!.uid).collection('questionnaire').snapshots(),
          ...
          if (!snapshot.hasData) {
            ...
            return new ListView(
              children: snapshot.data!.docs.map((document) {
                return document['submitted'] == true ? Padding(
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        ...
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                              builder: (context) => QuestionnaireDetailsPage(docId: document.id)),
                                          );
                                      },
                                      child: Container(
                                        width: 30,
